...
export class SkillTextComponent  implements OnInit{
  ...
  descriptionE: string = 'My journey has involved working on diverse projects, employing a range of frontend technologies and concepts. I am open to embracing new technologies and methodologies to Continously enhance my skills and stay ahead in the ever-evolving landscape of web development.';
  descriptionDe: string = ' Meine Reise hat mich dazu geführt, an vielfältigen Projekten zu arbeiten und eine Reihe von Frontend-Technologien und Konzepten einzusetzen. Ich bin offen dafür, neue Technologien und Methoden zu übernehmen, um meine Fähigkeiten kontinuierlich zu verbessern und in der sich ständig weiterentwickelnden Welt der Webentwicklung voraus zu sein.';
